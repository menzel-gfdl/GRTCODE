...
int main(int argc, char **argv)
{
    ...
    add_argument(&parser, "level_file", NULL, "Input level data file.", NULL);
    add_argument(&parser, "single_file", NULL, "Input single data file.", NULL);
    ...
    char level_file[valuelen];
    get_argument(parser, "level_file", level_file);
    char single_file[valuelen];
    get_argument(parser, "single_file", single_file);
    create_atmosphere(&atm, level_file, single_file, molecules, num_molecules, cfc,
