...
HOST DEVICE static void cloudiness(int const num_layers, fp_t const * overlap_parameter,
                                   fp_t const * random1, fp_t const * random2, fp_t * x)
{
    int i;
...
HOST DEVICE static fp_t specific_saturation_humidity(int const num_shape, int const num_x,
                                                     fp_t const * x, fp_t const * y_inverse,
...
HOST DEVICE static fp_t width(int const num_shape, int const num_x, fp_t const * x, fp_t const * y,
                              int const p, int const q, fp_t const cloud_fraction,
                              fp_t const lwc, fp_t const iwc, fp_t const qs)
{
