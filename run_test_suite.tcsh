...
set h2o_rfm_reference_file = h2o_rfm_small_subset.spc
set co2_rfm_reference_file = co2_rfm_small_subset.spc
set o3_rfm_reference_file = o3_rfm_small_subset.spc
set n2o_rfm_reference_file = n2o_rfm_small_subset.spc
set co_rfm_reference_file = co_rfm_small_subset.spc
set ch4_rfm_reference_file = ch4_rfm_small_subset.spc
set o2_rfm_reference_file = o2_rfm_small_subset.spc

#Set default values
set test_type = "smallsubset"
set atmos_data_file = "smallSubset_2t.nc"
set max_wavenumber = "10000"
...
./grtcode.x -aINPUT/$atmos_data_file -o$h2o_output_file -W$max_wavenumber -1a HITFILES/$h2o_hitran_file

#Carbon dioxide
echo "Calculating the carbon dioxide spectra ..."
./grtcode.x -aINPUT/$atmos_data_file -o$co2_output_file -W$max_wavenumber -2$co2_ppmv HITFILES/$co2_hitran_file

#Ozone
echo "Calculating the ozone spectra ..."
./grtcode.x -aINPUT/$atmos_data_file -o$o3_output_file -W$max_wavenumber -3a HITFILES/$o3_hitran_file

#Nitrous oxide
echo "Calculating the nitrous oxide spectra ..."
./grtcode.x -aINPUT/$atmos_data_file -o$n2o_output_file -W$max_wavenumber -4$n2o_ppmv HITFILES/$n2o_hitran_file

#Carbon monoxide
echo "Calculating the carbon monoxide spectra ..."
./grtcode.x -aINPUT/$atmos_data_file -o$co_output_file -W$max_wavenumber -5$co_ppmv HITFILES/$co_hitran_file

#Methane
echo "Calculating the methane spectra ..."
./grtcode.x -aINPUT/$atmos_data_file -o$ch4_output_file -W$max_wavenumber -6$ch4_ppmv HITFILES/$ch4_hitran_file

#Oxygen
echo "Calculating the oxygen spectra ..."
./grtcode.x -aINPUT/$atmos_data_file -o$o2_output_file -W$max_wavenumber -7$o2_ppmv HITFILES/$o2_hitran_file
